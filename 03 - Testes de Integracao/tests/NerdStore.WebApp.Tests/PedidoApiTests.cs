...
namespace NerdStore.WebApp.Tests
{
    ...
    public class PedidoApiTests
    {
        ...
        {
            // Arrange
            var produtoId = new Guid("d986add4-f5ec-422c-bfa3-aaea716c5f67");
            await _testsFixture.RealizarLoginApi();
            _testsFixture.Client.AtribuirToken(_testsFixture.UsuarioToken);
            ...
            // Assert
            deleteResponse.EnsureSuccessStatusCode(); // Testando o retorno da API, sendo assim testando os retornos da API;
        }
    }
}
